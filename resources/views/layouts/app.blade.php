...
<body class="  ">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="{{ route('dashboard') }}" class="navbar-brand">
                ...
                <h4 class="logo-title">EventPass</h4>
            </a>
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('evenements.index') }}">
                            ...
                            <span class="item-name">Liste des évènements</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('evenements.participants', ['id' => $evenement->id]) }}">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="item-name">Liste des participants</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="{{route('utilisateurs.index')}}">
                            ...
                            <span class="item-name">Tous les utilisateurs</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">Autres Pages</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " href="{{route('evenements.actifs')}}">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="item-name">Evènements actifs</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " href="{{route('evenements.expires')}}">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="item-name">Evènements terminés</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " href="{{route('evenements.supprimes')}}">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="container-fluid navbar-inner">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" id="mail-drop" aria-haspopup="true" aria-expanded="false"
                                    href="/">
  ...
  // Ajouter des styles directement après l'initialisation
  $('.select2-container .select2-selection--single').css({
      ...
      'border-radius': '4px'
            ...
            $('.select2-container--default .select2-selection--single').on('focus', function() {
